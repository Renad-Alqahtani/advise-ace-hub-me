    ...
    <section className="relative overflow-hidden py-20 lg:py-32">
      ...
      <div className="container mx-auto px-4">
        <div className="mx-auto max-w-4xl text-center">
          ...
          {/* Main heading */}
          <h1 className="animate-fade-up font-display text-4xl font-bold tracking-tight sm:text-5xl lg:text-6xl" style={{ animationDelay: '0.1s' }}>
            Discover Your
          ...
          <p className="animate-fade-up mx-auto mt-6 max-w-2xl text-lg text-muted-foreground" style={{ animationDelay: '0.2s' }}>
            Get personalized career recommendations based on your skills, academic background, and market trends. Connect with mentors and advisors to guide your journey.
          </p>
          ...
          {/* Stats */}
          <div className="animate-fade-up mt-16 grid grid-cols-1 sm:grid-cols-3 gap-8" style={{ animationDelay: '0.4s' }}>
